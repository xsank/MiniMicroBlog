...
urlpatterns = patterns('',
    ...
    url(r'^sysmsg/(?P<pageindex>\d+)/$','microblog.views.loadsysmsg'),
    ...
    url(r'^register/success/$','django.views.generic.simple.direct_to_template',
        {'template':'prompt/regsuccess.html'}),
    ...
    url(r'^user/leavemsg/$','microblog.views.leavemsg'),
    ...
    url(r'^detailsysmsg/(?P<sysmsgid>\d+)/$','microblog.views.sysmsgdetail'),
    ...
    url(r'^prompt/(?P<way>\bdelsysmsg\b)/(?P<param>[\w_\d]+)/$','microblog.views.systeminfo'),
